...
//#define API_MAIN_URL                @"http://rsapi.edanat.com/v1.0"
#define API_MAIN_URL                @"http://rsapi.bezaat.com/v1.0"
#define BRAND_THUMB_SIZE            90.0f

#pragma mark - shared json keys

#define STATUS_CODE_JKEY            @"StatusCode"
#define STATUS_MSG_JKEY             @"StatusMessage"
#define DATA_JKEY                   @"Data"


//#define BANNER_MPU              @"/5245337/Bezaat..ios..App..Real..Estate..320x50"
