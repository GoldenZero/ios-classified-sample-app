...
- (void) manager:(BaseDataManager*)manager connectionDidSucceedWithObjects:(NSData*)result {
    ...
    if (requestInProgress == RequestInProgressUploadLOGO) {
        ...
        NSArray *ads = [[AdsManager sharedInstance] createCarAdsArrayWithData:(NSArray *)result];
        ...
        if (statusCode == 320) {
            ...
            NSArray *ads = [[AdsManager sharedInstance] createStoreOrderArrayWithData:(NSArray *)result];
