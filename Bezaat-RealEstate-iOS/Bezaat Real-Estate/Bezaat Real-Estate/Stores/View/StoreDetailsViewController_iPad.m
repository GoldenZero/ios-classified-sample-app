//
//  StoreDetailsViewController_iPad.m
//  Bezaat
//
...
@interface StoreDetailsViewController_iPad () {
...
@implementation StoreDetailsViewController_iPad
...
- (IBAction)menueBtnPress:(id)sender {
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone) {
        ...
        if (sender == menueBtn1) {
            [menueBtn1 setImage:[UIImage imageNamed:@"iPad_userPage_all_section_on.png"] forState:UIControlStateNormal];
            [menueBtn2 setImage:[UIImage imageNamed:@"iPad_userPage_special_section_off.png"] forState:UIControlStateNormal];
            [menueBtn3 setImage:[UIImage imageNamed:@"iPad_userPage_active_section_off.png"] forState:UIControlStateNormal];
            [menueBtn4 setImage:[UIImage imageNamed:@"iPad_userPage_cancel_section_off.png"] forState:UIControlStateNormal];
            ...
            [menueBtn1 setImage:[UIImage imageNamed:@"iPad_userPage_all_section_off.png"] forState:UIControlStateNormal];
            [menueBtn2 setImage:[UIImage imageNamed:@"iPad_userPage_special_section_on.png"] forState:UIControlStateNormal];
            [menueBtn3 setImage:[UIImage imageNamed:@"iPad_userPage_active_section_off.png"] forState:UIControlStateNormal];
            [menueBtn4 setImage:[UIImage imageNamed:@"iPad_userPage_cancel_section_off.png"] forState:UIControlStateNormal];
            ...
            [menueBtn1 setImage:[UIImage imageNamed:@"iPad_userPage_all_section_off.png"] forState:UIControlStateNormal];
            [menueBtn2 setImage:[UIImage imageNamed:@"iPad_userPage_special_section_off.png"] forState:UIControlStateNormal];
            [menueBtn3 setImage:[UIImage imageNamed:@"iPad_userPage_active_section_on.png"] forState:UIControlStateNormal];
            [menueBtn4 setImage:[UIImage imageNamed:@"iPad_userPage_cancel_section_off.png"] forState:UIControlStateNormal];
            ...
            [menueBtn2 setImage:[UIImage imageNamed:@"iPad_userPage_special_section_off.png"] forState:UIControlStateNormal];
            [menueBtn3 setImage:[UIImage imageNamed:@"iPad_userPage_active_section_off.png"] forState:UIControlStateNormal];
            [menueBtn4 setImage:[UIImage imageNamed:@"iPad_userPage_cancel_section_on.png"] forState:UIControlStateNormal];
...
- (UITableViewCell *)tableView:(UITableView *)_tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.modelYearLabel.text = adv.rooms;
...
- (void)tableView:(UITableView *)_tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (adv.thumbnailURL) {   //ad with image
        if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone){
            ...
            details.currentAdID = adv.adID;
            details.currentStore = self.currentStore;
            details.parentStoreDetailsView = self;
            details.storeParentVC = self;
...
- (void)featureAdv:(NSInteger)advID {
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone) {
        ...
        int index = -1;
        for (int i =0; i < currentStoreAds.count; i++) {
            if ([(Ad *)currentStoreAds[i] adID] == currentAdvID) {
                index = i;
                break;
            }
        }
        if (index > -1) {
            ...
            if ([(Ad *) currentStoreAds[index] thumbnailURL]) //ad with images
