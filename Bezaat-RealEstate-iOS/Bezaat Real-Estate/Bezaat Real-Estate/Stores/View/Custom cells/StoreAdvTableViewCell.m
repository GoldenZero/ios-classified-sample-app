...
- (void) setIsFeatured:(BOOL)_isFeatured {
    ...
    {
    if (isFeatured) {
        [featureButton setImage:[UIImage imageNamed:@"unfeatuersIcons"] forState:UIControlStateNormal];
        ...
        [featureButton setImage:[UIImage imageNamed:@"featuersIcons"] forState:UIControlStateNormal];
    ...
    {
        if (isFeatured) {
            [featureButton setImage:[UIImage imageNamed:@"iPad_userPage_unfeature.png"] forState:UIControlStateNormal];
            CGRect frame = featureButton.frame;
            featureButton.frame = frame;
            bgImageView.image = [UIImage imageNamed:@"bkgorderlist_orange.png"];
            featureTagImageView.hidden = NO;
        }
        else {
            [featureButton setImage:[UIImage imageNamed:@"iPad_userPage_feature.png"] forState:UIControlStateNormal];
            bgImageView.image = [UIImage imageNamed:@"bkgorderlist.png"];
            featureTagImageView.hidden = YES;
        }
    }
}
