...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        iPad_checkedImageName =@"iPad_featureStore_cell_on.png";
        iPad_unCheckedImageName=@"iPad_featureStore_cell_off.png";
        choosenCell=0;
...
- (IBAction)laterBtnPressed:(id)sender {
    ...
    StoreDetailsViewController_iPad *vc1;
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone){
        ...
        vc1= [[StoreDetailsViewController_iPad alloc] initWithNibName:@"StoreDetailsViewController_iPad" bundle:nil];
    vc1.currentStore = self.storeID;
    vc1.fromSubscribtion = YES;
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    FeatureAdCell* mycell = (FeatureAdCell*)[self.tableView cellForRowAtIndexPath:indexPath];
    if (UI_USER_INTERFACE_IDIOM() != UIUserInterfaceIdiomPhone)
        [mycell.bkgImg setImage:[UIImage imageNamed:(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone ? checkedImageName : iPad_checkedImageName)]];
...
-(void)paymentQueue:(SKPaymentQueue *)queue updatedTransactions:(NSArray *)transactions
{
    ...
    {
        NSLog(@"status of trans : %ld",(long)transaction.transactionState);
