//
//  StoreDetailsViewController_iPad.h
//  Bezaat
//
...
@interface StoreDetailsViewController_iPad : UIViewController<UITableViewDataSource,UITableViewDelegate,UIActionSheetDelegate,StoreManagerDelegate,FeatureingDelegate,GADBannerViewDelegate>
