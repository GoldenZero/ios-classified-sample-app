...
static NSString * pricing_options_url = @"/json/featured-ad-pricing?countryid=%i&purpose=%@";
...
- (void) loadPricingOptionsForCountry:(NSInteger) countryID forPurpose:(NSString*)purpose withDelegate:(id <PricingOptionsDelegate>) del {
    ...
    NSString * fullURLString = [NSString stringWithFormat:pricing_options_url, 2,purpose];
