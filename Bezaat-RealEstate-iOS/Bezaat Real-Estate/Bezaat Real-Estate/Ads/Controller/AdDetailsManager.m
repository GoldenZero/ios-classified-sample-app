...
@implementation AdDetailsManager
...
+ (AdDetailsManager *) sharedInstance {
    static AdDetailsManager * instance = nil;
    if (instance == nil) {
        instance = [[AdDetailsManager alloc] init];
    }
    return instance;
}
...
- (void) manager:(BaseDataManager*)manager connectionDidSucceedWithObjects:(NSData*) result {
    ...
    else
    {
        if (manager == internetMngr) {
            if (self.delegate)
            {
                AdDetails * detailsObject = [self createCarDetailsObjectWithData:(NSArray *)result];
...
- (AdDetails * ) createCarDetailsObjectWithData:(NSArray *) data {
            ...
            if (dataDict)
            {
                ...
                if ([tryCastString class] != [NSString class])
                {
                    ...
                    if (parsedImagesArray)
                    {
                        ...
                        {
                            AdDetailsImage * imgObj =
                            [[AdDetailsImage alloc]
                ...
                if ([tryCastString class] != [NSString class])
                {
                    ...
                    if (parsedAttributesArray)
                    {
                        ...
                        {
                            AdDetailsAttribute * attrObj =
                            [[AdDetailsAttribute alloc]
                ...
                [[AdDetails alloc]
                 ...
                 adCountryID:[dataDict objectForKey:DETAILS_AD_COUNTRY_ID_JKEY] adCategoryID:[dataDict objectForKey:@"CategoryID"] adMainCategoryID:[dataDict objectForKey:@"MainCategoryID"] adRooms:[dataDict objectForKey:@"Rooms"] adRoomsCount:[dataDict objectForKey:@"RoomsCount"]
                 ];
...
- (void) cacheImageSizeForGallery:(AdDetailsImage *) img {
