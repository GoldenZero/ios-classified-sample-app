...
- (void)viewDidLoad
{
    ...
    if (self.type == 1) {
        self.titleTextView.text = [NSString stringWithFormat:@"عزيزنا العميل: %@\nشكرا لتعاملكم مع بيزات، لقد تم استلام طلبك رقم %@ الخاص بالإعلان رقم %i للإشتراك في  باقة %@, وسيتم إنهاء الطلب بعد إتمام عملية الدفع يرجى استخدام احد حساباتنا التالية كما يمكنك الذهاب الى طلبات المتاجر في القائمة الرئيسية لارسال معلومات التحويل البنكي\n\nيرجى ارسال رقم او صورة عن التحويل البنكي الى البريد الالكتروني info@bezaat.com ،أو الاتصال على الرقم: (+966)-920004147",profile.userName,self.Order,self.AdID,self.ProductName];
        //GA
...
- (IBAction)homeBtnPressed:(id)sender {
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
        ...
        vc =[[StoreOrdersViewController alloc]initWithNibName:@"StoreOrdersViewController_iPad" bundle:nil];
