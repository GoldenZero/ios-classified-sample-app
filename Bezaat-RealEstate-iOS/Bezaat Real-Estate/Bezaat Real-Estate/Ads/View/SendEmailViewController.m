...
- (IBAction)sendBtnPrss:(id)sender {
    ...
    [[AdsManager sharedInstance] sendEmailofName:self.nameField.text withEmail:self.emailField.text phoneNumber:self.phoneNumberField.text.integerValue message:self.subjectField.text withAdID:self.DetailsObject.adID WithDelegate:self];
