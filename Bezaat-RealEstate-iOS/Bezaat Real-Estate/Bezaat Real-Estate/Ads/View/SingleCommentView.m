...
- (id) initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        UIImageView * separator = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.frame.size.height - 4, 320, 4)];
...
- (id) initWithCommentText:(NSString *) cText {
    ...
    CGSize textSize = [cText sizeWithFont:[UIFont systemFontOfSize:14.0f] constrainedToSize:CGSizeMake(320, CGFLOAT_MAX) lineBreakMode:NSLineBreakByWordWrapping];
    
    self.commentTextHeight = textSize.height;
    
    CGRect cellFrame = CGRectMake(0, 0, 320, initial_height + self.commentTextHeight);
