...
@interface ProfileDetailsViewController : UIViewController<ProfileManagerDelegate,UITableViewDataSource,UITableViewDelegate,LocationManagerDelegate,ProfileUpdateDelegate>
{
