            ...
            if (tableView == self.profileTable) {
                ...
                switch ([indexPath section]) {
                    ...
                    case 2:
                    {
                        ...
                        cell.customLbl.font = [UIFont boldSystemFontOfSize:19];
    ...
    if (alertView.tag == 0) {
        ...
        [self presentViewController:vc animated:YES completion:nil];
            ...
            if (iPad_isLoggingOut) {
                iPad_isLoggingOut = NO;
                HomePageViewController *vc =[[HomePageViewController alloc]initWithNibName:@"HomePageViewController_iPad" bundle:nil];
                vc.modalTransitionStyle = UIModalTransitionStyleCrossDissolve;
                [self presentViewController:vc animated:YES completion:nil];
