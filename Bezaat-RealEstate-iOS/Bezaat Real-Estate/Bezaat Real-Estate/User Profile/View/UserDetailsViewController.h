...
@interface UserDetailsViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,BrowseAdsDelegate,LocationManagerDelegate,GADBannerViewDelegate>
{
