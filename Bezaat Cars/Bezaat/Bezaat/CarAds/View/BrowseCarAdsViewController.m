...
- (CGSize) collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    return CGSizeMake(315.0f, 337); //the dimensions of all cell types
}
...
- (UICollectionViewCell *) collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (carAdObject.storeID > 0)
    {
        ...
        if (savedProfile)   //logged in
        {
            ...
            {
                if (carAdObject.isFeatured) {
                    [cell.favoriteButton setImage:[UIImage imageNamed:@"tb_car_brand_orange_like.png"] forState:UIControlStateNormal];
                }
                else{
                    [cell.favoriteButton setImage:[UIImage imageNamed:@"tb_car_brand_blue_like.png"] forState:UIControlStateNormal];
                }
...
- (IBAction)iPad_chooseDistanceRangeBtnPressed:(id)sender {
    ...
    if (!self.distanceRangePopOver) {
        ...
        distanceRangeVC.showingFromYearObjects = NO;
        distanceRangeVC.showingToYearObjects = NO;
...
- (IBAction)iPad_chooseYearToBtnPressed:(id)sender {
    ...
    if (!self.yearToRangePopOver) {
        ...
        yearToRangeVC.showingDistanceRangeObjects = NO;
...
- (void) didChooseTableItemWithObject:(id) obj {
    ...
    self.iPad_distanceLabel.text = distanceObj.rangeName;
