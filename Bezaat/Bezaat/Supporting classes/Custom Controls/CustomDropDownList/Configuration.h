...
#define BUTTON_LABEL_ACTIVE_COLOR							[UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:1.0]
...
#define TITLE_LABEL_COLOR									[UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:1.0]
...
#define ITEM_TITLE_LABEL_FRAME								CGRectMake(46.0,14.0,180.0,18.0)
#define BUTTON_TITLE_LABEL_FRAME							CGRectMake(50.0,13.0,180.0,18.0)
